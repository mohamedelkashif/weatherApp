...
<div>
    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin">
         ...
         <h1 class="form-signin-heading">Orange Assignment</h1>
         <img class="relative" src="<c:url value="/resources/images/orange.PNG"/>" /> 
          <h1 class="weather">Weather Tips for employees</h1>
        ...
        <spring:bind path="email">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="email" class="form-control" placeholder="Name"
                            autofocus="true"></form:input>
